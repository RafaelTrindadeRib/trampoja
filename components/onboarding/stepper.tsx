          ...
          return (
            <li
              ...
              className={cn(
                ...
                index < steps.length - 1 && 'after:absolute after:left-[calc(50%+20px)] after:top-5 after:h-0.5 after:w-[calc(100%-40px)] after:content-[""]',
                index < steps.length - 1 && isCompleted && 'after:bg-primary-600',
                index < steps.length - 1 && !isCompleted && 'after:bg-muted-200',
              )}
            >
              <button
                type="button"
                ...
                className={cn(
                  ...
                  isClickable && 'cursor-pointer hover:bg-primary-700 hover:border-primary-700',
